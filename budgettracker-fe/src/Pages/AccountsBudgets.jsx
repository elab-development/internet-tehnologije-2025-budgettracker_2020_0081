...
const AccountsBudgets = ({ token }) => {
  ...
  return (
    <div className="page">
      <div className="accounts-budgets-layout">
        {/* ACCOUNTS */}
        ...
        <div className="section-card">
          ...
          <div className="filters-bar">
            <select
              ...
              onChange={(e) =>
                setFilterType((p) => ({ ...p, month: e.target.value, page: 1 }))
              }
            >
            ...
            <input
              ...
              onChange={(e) =>
                setFilterType((p) => ({ ...p, year: e.target.value, page: 1 }))
              }
              style={{ maxWidth: 160 }}
            />
            ...
            <select
              ...
              onChange={(e) =>
                setFilterType((p) => ({ ...p, categoryName: e.target.value, page: 1 }))
              }
            >
          ...
          <div className="sw-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={createAccount} className="modal-form">
              ...
              <input
                ...
                onChange={(e) =>
                  setAccountForm((p) => ({ ...p, initial_balance: e.target.value }))
                }
              />
      ...
      {showBudgetCreateModal && (
        <div className="sw-modal-backdrop" onClick={() => setShowBudgetCreateModal(false)}>
          <div className="sw-modal" onClick={(e) => e.stopPropagation()}>
            ...
            {budgetCreateSuccess && (
              <div className="alert alert-success">{budgetCreateSuccess}</div>
            )}
          ...
          <div className="sw-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={updateBudget} className="modal-form">
              ...
              <input
                ...
                onChange={(e) =>
                  setBudgetEditForm((p) => ({ ...p, planned_amount: e.target.value }))
                }
              />
